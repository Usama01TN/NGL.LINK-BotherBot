...
try:
    from .createheaderimage import MaskedPixmapItem, createThemeHeaderImage, createHeaderImage
    from ._theme import Theme, getTheme, getThemes, setTheme, setWidgetTheme, updatePalette
except:
    from createheaderimage import MaskedPixmapItem, createThemeHeaderImage, createHeaderImage
    from _theme import Theme, getTheme, getThemes, setTheme, setWidgetTheme, updatePalette
